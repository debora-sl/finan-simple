...
Você está trabalhando em um sistema de gestão de controle financeiro.
...
- SEMPRE use .inputSchema e NUNCA .schema ao criar server actions com o next-safe-action.
...
- **SEMPRE** use o Serena para semantic code retrieval e editing tools
